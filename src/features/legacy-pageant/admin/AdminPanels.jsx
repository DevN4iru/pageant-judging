...
import { LoadingPanel, WinnerAnnouncement } from '../components/SharedUi.jsx';
import { formatDateTime } from '../utils/formatting.js';

function FinalInterviewAdminPanel({ api }) {
...
export function AdminPanel({ api }) {
  ...
  return (
    <main className="content-grid admin-dashboard-view">
      ...
      <FinalInterviewAdminPanel api={api} />
{ranked.length >= 3 && (
